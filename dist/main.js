...
var Carousel = function Carousel(data, carouselId, dataFlickity, itemComponent) {
  var createCarouselItems = function createCarouselItems() {
    var items = "";
    data.forEach(function (item) {
      itemComponent(item);
      var comp = itemComponent(item);
  ...
  new (flickity__WEBPACK_IMPORTED_MODULE_1___default())(elem, dataFlickity);
};
...
var MovieCard = function MovieCard(_ref) {
  ...
  cardDiv.innerHTML = "   \n    <img \n        src=\"https://image.tmdb.org/t/p/w200/".concat(poster_path, "\"\n        alt=\"orange tree\"\n    />  \n ");
  return cardDiv;
};

/***/ }),

/***/ "./src/js/components/MovieDetailedCard.js":
/*!************************************************!*\
  !*** ./src/js/components/MovieDetailedCard.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MovieDetailedCard": () => (/* binding */ MovieDetailedCard)
/* harmony export */ });
var MovieDetailedCard = function MovieDetailedCard(_ref) {
  var id = _ref.id,
      backdrop_path = _ref.backdrop_path,
      title = _ref.title;
  var cardDiv = document.createElement("div"); // const getMovieDetails = () => {
  //   fetch(
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MovieDetailedCard": () => (/* reexport safe */ _MovieDetailedCard_js__WEBPACK_IMPORTED_MODULE_0__.MovieDetailedCard),
/* harmony export */   "MovieCard": () => (/* reexport safe */ _MovieCard_js__WEBPACK_IMPORTED_MODULE_1__.MovieCard),
/* harmony export */   "Carousel": () => (/* reexport safe */ _Carousel_js__WEBPACK_IMPORTED_MODULE_2__.Carousel),
/* harmony export */   "NavBar": () => (/* reexport safe */ _NavBar_js__WEBPACK_IMPORTED_MODULE_3__.NavBar)
/* harmony export */ });
/* harmony import */ var _MovieDetailedCard_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MovieDetailedCard.js */ "./src/js/components/MovieDetailedCard.js");
/* harmony import */ var _MovieCard_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MovieCard.js */ "./src/js/components/MovieCard.js");
/* harmony import */ var _Carousel_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Carousel.js */ "./src/js/components/Carousel.js");
/* harmony import */ var _NavBar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./NavBar.js */ "./src/js/components/NavBar.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "injectedMovies": () => (/* binding */ injectedMovies)
/* harmony export */ });
var injectedMovies = {
  "now-playing": [{
    adult: false,
...
/***/ "./src/serviceWorkerRegisteration.js":
/*!*******************************************!*\
  !*** ./src/serviceWorkerRegisteration.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ registerSW)
/* harmony export */ });
...
"use strict";
module.exports = __webpack_require__.p + "e5117e8e0cea57c9a92f.jpg";
...
"use strict";
module.exports = __webpack_require__.p + "2e5a00cc5b51292dab91.png";
...
/* harmony import */ var _serviceWorkerRegisteration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./serviceWorkerRegisteration */ "./src/serviceWorkerRegisteration.js");
/* harmony import */ var _js_injectedMovies_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/injectedMovies.js */ "./src/js/injectedMovies.js");
/* harmony import */ var _js_components_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/components/index.js */ "./src/js/components/index.js");
...
var urls = {
  "now-playing": "https://api.themoviedb.org/3/movie/now_playing?api_key=6c49562f5c85b63008a56de98a05c8c8&language=en-US&page=1",
  "top-rated": "https://api.themoviedb.org/3/movie/top_rated?api_key=6c49562f5c85b63008a56de98a05c8c8&language=en-US&page=1",
  popular: "https://api.themoviedb.org/3/movie/popular?api_key=6c49562f5c85b63008a56de98a05c8c8&language=en-US&page=1"
};
...
var getAllMovies = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.t0 = Promise;
            _context.next = 4;
            return fetch(urls["now-playing"]);

          case 4:
            _context.t1 = _context.sent.json();
            _context.next = 7;
            return fetch(urls["top-rated"]);

          case 7:
            _context.t2 = _context.sent.json();
            _context.next = 10;
          ...
          case 10:
            ...
            return _context.abrupt("return", _context.t0.all.call(_context.t0, _context.t4).then(function (res) {
              var obj = {};
              {
              ...
              localforage__WEBPACK_IMPORTED_MODULE_2___default().setItem("allMovies", obj);
              return obj;
            }));
          ...
          case 15:
            ...
            console.log("couldn't get movies..", _context.t5);
  ...
  return function getAllMovies() {
    return _ref.apply(this, arguments);
  };
}();

var displayNavBar = function displayNavBar() {
  var nowPlayingContainer = document.getElementById("navbar");
  nowPlayingContainer.appendChild((0,_js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.NavBar)());
};

var displayMovies = function displayMovies() {
  var displayMoviesLists = function displayMoviesLists(data) {
    ...
    (0,_js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.Carousel)(data["now-playing"], "#now-playing-carousel" + (type && "-" + type), {
      freeScroll: true,
      wrapAround: true,
      contain: true,
      pageDots: false
    }, _js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.MovieDetailedCard);
    (0,_js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.Carousel)(data["top-rated"], "#top-rated-carousel" + (type && "-" + type), {
      freeScroll: true,
      contain: true,
      pageDots: false
    }, _js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.MovieCard);
    (0,_js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.Carousel)(data["trending"], "#trending-carousel" + (type && "-" + type), {
      freeScroll: true,
      contain: true,
      pageDots: false
    }, _js_components_index_js__WEBPACK_IMPORTED_MODULE_5__.MovieCard);
  ...
  localforage__WEBPACK_IMPORTED_MODULE_2___default().getItem("allMovies").then(function (movies) {
    displayMoviesLists(movies);
  })["catch"](displayMoviesLists(_js_injectedMovies_js__WEBPACK_IMPORTED_MODULE_4__.injectedMovies));
  getAllMovies().then(function (allMovies) {
...
(0,_serviceWorkerRegisteration__WEBPACK_IMPORTED_MODULE_3__.default)();
displayContent();
})();
